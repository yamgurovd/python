...
link https://stepik.org/lesson/265081/step/5?unit=246029"""


first_password = str(input('Введите пароль 1: '))
last_password = str(input('Введите пароль 2: '))


if first_password == last_password:
    print("Пароль принят")
else:
